...
PUBLIC_KEY, PRIVATE_KEY, PERSONAL_MAIL_SENDER, PERSONAL_MAIL_SENDER_PASSWORD
)
...
def get_public_key() -> str:
    ...
    if public_key_path:
        try:
            ...
            logging.log(msg=f"{public_key_path} file content not found, Error: {e}", level=2)
    else:
...
def get_private_key() -> str:
    ...
    if private_key_path:
        try:
            ...
            logging.log(msg=f"{private_key_path} file content not found, Error: {e}", level=2)
    else:
